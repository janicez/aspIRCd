...
const char *libratbox_platform = "Linux hyphovy.net 4.9.0-8-amd64 #1 SMP Debian 4.9.144-3.1 (2019-02-19) x86_64 GNU/Linux";
const char *libratbox_serno = SERIALNUM;
const char *libratbox_creation = "Tue Mar 26 2019 at 04:40:40 EDT";
